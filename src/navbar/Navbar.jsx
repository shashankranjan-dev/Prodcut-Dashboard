...
import { Dashboard, Products, Sign, Log } from "../pages/index";
    ...
    <div className="w-full   h-full bg-gray-100">
      <div className="flex  flex-no-wrap">
        ...
        >
          ...
          <img class="w-12 mt-2" src="/circle-outline-svgrepo-com.svg" alt="" />
          
        </div>
        <div className='flex justify-center'>
        <h1 className="text-2xl -mt-6 ml-2 font-bold text-indigo-600">
                ClarityUI
              </h1></div>
                  <div
                    id="closeSideBar"
            ...
            <div className=" -ml-2 mt-4 flex flex-col px-6 justify-start items-center   w-full   ">
              <button className="focus:outline-none focus:text-white  flex jusitfy-start     text-black hover:text-black rounded py-3  items-center space-x-6 w-full ">
                <svg
                  width={24}
                  height={24}
