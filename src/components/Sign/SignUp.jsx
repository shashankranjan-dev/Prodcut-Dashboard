...
function SignUp() {
  ...
  return (
    ...
    <div class="flex items-center justify-center h-screen container">
      ...
      <div class="min-w-fit flex-col border bg-white px-6 py-14 shadow-md rounded-lg ">
        <div class="mb-8 flex justify-center">
          <img class="w-16" src="/circle-outline-svgrepo-com.svg" alt="" />
          
        </div>
        <div className='flex justify-center'>
        <h1 className="text-3xl -mt-6 font-bold text-indigo-600">
                ClarityUI
              </h1></div>
        <form onSubmit="registerUser(registerForm.value)" className="flex mt-10 flex-col text-sm rounded-md">
          <input class="mb-5 rounded-[4px] border p-3 hover:outline-none shadow-sm focus:outline-none hover:border-yellow-500 " type="text" placeholder="Username or Email id" />
          <input class="border mb-5 rounded-[4px] p-3 hover:outline-none shadow-sm focus:outline-none hover:border-yellow-500" type="password" placeholder="Create Password" />
          <input class="border rounded-[4px] p-3 hover:outline-none shadow-sm focus:outline-none hover:border-yellow-500" type="text" placeholder="Enter Mobile Number" />
        </form>
        <button onclick="toggleForm()"
        class="mt-5 w-full border p-2 bg-gradient-to-r from-blue-800 bg-gray-500 text-white rounded-[4px] hover:bg-slate-400 scale-105 duration-300" type="submit">Sign Up</button>
